...
int32_t function_128a0(int32_t *p_a1, int32_t *p_a2, int32_t *p_a3,
                       ...
                       uint32_t i_a7);
int32_t function_1338c(uint32_t i_a1, int32_t i_a2);
int32_t function_13770(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
int32_t function_137ac(void);
int32_t function_137b0(int32_t i_a1, int32_t *p_a2);
int32_t function_137b4(void);
int32_t function_137bc(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4);
...
int32_t function_e3033b6c(void);
int32_t function_e3033b7c(void);
...
int32_t entry_point(int32_t i_a1, int32_t i_a2) {
    ...
    int32_t i_v2 = function_10720(0x1338c, i_a2, &i_v1, 0x13771, 0x1338c, i_a1,
                                  &i_v1); // 0x10854
...
// Address range: 0x128a0 - 0x1338c
int32_t function_128a0(int32_t *p_a1, int32_t *p_a2, int32_t *p_a3,
                       int32_t *p_a4, uint32_t i_a5, uint32_t i_a6,
                       uint32_t i_a7) {
    int32_t i_v1 = (int32_t)p_a1;
    int32_t i_v2; // bp-200, 0x128a0
    function_137b0(i_v1, &i_v2);
    ...
    i_v5 = i_v27;
    if (i_v27 != 0) {
        int32_t i_v56 = function_10798((int32_t) "/tmp/tmpfw/miner.pem", "w",
                                       i_v54, (int32_t *)i_v27); // 0x12df0
        i_v5 = i_v56;
        if (i_v56 == 0) {
            // 0x12e4c
            function_107f0("Dump Miner.pem Failed!\r", (int32_t) "w", i_v54, 0);
            i_v5 = 15;
            // 0x13380
            return 15;
        }
        // 0x12e04
        function_107d4((int32_t *)i_v53, 1, i_v52, i_v56);
        function_10738(i_v56);
        int32_t i_v57 = function_10798((int32_t) "/tmp/tmpfw/miner.pem.sig",
                                       "w", i_v52, (int32_t *)i_v56); // 0x12e34
        i_v5 = i_v57;
        if (i_v57 == 0) {
            // 0x12e88
        ...
        // 0x12e60
        function_107d4((int32_t *)i_v54, 1, 256, i_v57);
        function_10738(i_v57);
    }
    // 0x12e9c
    int32_t i_v58; // bp-2288, 0x128a0
    function_10744(&i_v58, 0, 1056, &i_v58);
    int32_t i_v59; // bp-2400, 0x128a0
    function_10820(&i_v59);
    function_10808(&i_v59, i_v10, 2048, &i_v59);
    function_10774(&i_v58, &i_v59, &i_v59, &i_v58);
    int32_t i_v60 = &i_v58;
    if (i_v28 != 0) {
        int32_t i_v61 = i_v60 + 32; // 0x12fcc
        for (int32_t i_v62 = 0; i_v62 < i_v38; i_v62++) {
            int32_t i_v63 = 5 * i_v62 + i_v10;             // 0x12f2c
            unsigned char i_v64 = *(char *)(i_v63 + 1310); // 0x12f38
            unsigned char i_v65 = *(char *)(i_v63 + 1311); // 0x12f60
            unsigned char i_v66 = *(char *)(i_v63 + 1312); // 0x12f88
            unsigned char i_v67 = *(char *)(i_v63 + 1313); // 0x12fb4
            unsigned char i_v68 = *(char *)(i_v63 + 1309); // 0x13000
            function_10dc8(i_v7,
                           0x10000 * (int32_t)i_v65 |
                               0x1000000 * (int32_t)i_v64 |
                               256 * (int32_t)i_v66 | (int32_t)i_v67,
                           i_v61 + 32 * i_v62, (int32_t)i_v68, 0, i_v27);
        }
        int32_t i_v69 = 0;
        int32_t i_v70 = i_v69 + 1;
        unsigned char i_v71 = *(char *)(i_v10 + 1309 + 5 * i_v69); // 0x13094
        function_10dc8(i_v7, 256, 32 * (i_v70 + i_v38) + i_v60, (int32_t)i_v71,
                       1, i_v27);
        while (i_v70 < i_v38) {
            // 0x13050
            i_v69 = i_v70;
            i_v70 = i_v69 + 1;
            i_v71 = *(char *)(i_v10 + 1309 + 5 * i_v69);
            function_10dc8(i_v7, 256, 32 * (i_v70 + i_v38) + i_v60,
                           (int32_t)i_v71, 1, i_v27);
        }
    }
    int32_t i_v72 = 0; // bp-2656, 0x130dc
    int32_t i_v73;     // bp-2652, 0x128a0
    function_10744(&i_v73, 0, 252, &i_v73);
    function_1075c(i_v7, -256, 2);
    function_1082c(&i_v72, 256, 1, i_v7);
    int32_t i_v74 = 0; // bp-2688, 0x1312c
    __asm_vmov_i32(0);
    float64_t f_v75; // 0x128a0
    int32_t i_v76;   // 0x128a0
    __asm_vst1_8(f_v75, f_v75, i_v76);
    __asm_vst1_8(f_v75, f_v75, i_v76);
    int32_t i_v77; // bp-2800, 0x128a0
    function_10820(&i_v77);
    function_10808(&i_v77, i_v60, 64 * i_v38 | 32, &i_v77);
    function_10774(&i_v74, &i_v77, &i_v77, &i_v74);
    int32_t i_v78 = function_107a4(i_v53, 1024);    // 0x131d4
    int32_t i_v79 = function_10768(i_v78, 0, 0, 0); // 0x131ec
    if (i_v79 == 0) {
        int32_t i_v80 = function_107c8(function_10714(0), 0); // 0x13210
        function_107bc("OpenSSL error: %s\n", i_v80, 0, i_v80);
        function_107f0("Load Pem Failed!", i_v80, 0, i_v80);
        i_v5 = 17;
        // 0x13380
        return 17;
    }
    int32_t i_v81 =
        function_10750(672, &i_v74, 32, (int32_t)&i_v72, 256, i_v79); // 0x1326c
    function_107fc(i_v79);
    if (i_v78 != 0) {
        // 0x13294
        function_10814(i_v78);
    }
    int32_t i_v82 = &i_v74; // 0x13250
    i_v5 = i_v81;
    if (i_v81 != 1) {
        int32_t i_v83 = function_107f0("Check File Sig failed!\r", i_v82, 32,
                                       i_v81);                    // 0x132b0
        int32_t i_v84 = function_107c8(function_10714(i_v83), 0); // 0x132c4
        function_107bc("OpenSSL error: %s\n", i_v84, 32, i_v84);
        i_v5 = 18;
        // 0x13380
        return 18;
    ...
    // 0x132f8
    function_10738(i_v7);
    function_107f0("All Done!\r", i_v82, 32, 0);
    i_v5 = i_v26;
    if (i_v26 != 0) {
        // 0x13318
        function_107f0("This Comment Of This Package:", i_v82, 32, i_v26);
        int32_t i_v85 = 0; // bp-3060, 0x13328
        int32_t i_v86;     // bp-3056, 0x128a0
        function_10744(&i_v86, 0, 253, &i_v86);
        int32_t i_v87 = i_v10 + 1360; // 0x1334c
        function_1078c(&i_v85, i_v87, 256, &i_v85);
        function_107f0((char *)&i_v85, i_v87, 256, (int32_t)&i_v85);
    }
    // 0x1337c
    i_v5 = 0;
    // 0x13380
...
int32_t function_1338c(uint32_t i_a1, int32_t i_a2) {
    ...
    int32_t *p_v1 = (int32_t *)(i_a2 + 4); // 0x133d0
    if (*(char *)*p_v1 != 45) {
        // 0x13764
        return 2;
    }
    int32_t i_v2 = 0; // bp-272, 0x133fc
    int32_t i_v3;     // bp-268, 0x1338c
    function_10744(&i_v3, 0, 252, &i_v3);
    int32_t i_v4 = 0; // bp-400, 0x13418
    int32_t i_v5;     // bp-396, 0x1338c
    function_10744(&i_v5, 0, 124, &i_v5);
    int32_t i_v6 = 0; // bp-528, 0x13434
    int32_t i_v7;     // bp-524, 0x1338c
    function_10744(&i_v7, 0, 124, &i_v7);
    int32_t i_v8; // bp-2576, 0x1338c
    function_10744(&i_v8, 0, 2048, &i_v8);
    int32_t i_v9; // bp-2832, 0x1338c
    function_10744(&i_v9, 0, 253, &i_v9);
    int32_t i_v10 = 0;   // 0x1338c
    int32_t i_v11 = 253; // 0x1338c
    switch (i_a1) {
    case 5: {
        int32_t *p_v12 = (int32_t *)(i_a2 + 8);             // 0x134b8
        uint32_t i_v13 = function_10780((int32_t *)*p_v12); // 0x134c0
        ...
        int32_t i_v14 = *p_v12; // 0x134ec
        function_107b0(&i_v2, i_v14);
        int32_t *p_v15 = (int32_t *)(i_a2 + 12);            // 0x13508
        uint32_t i_v16 = function_10780((int32_t *)*p_v15); // 0x13510
        ...
        int32_t i_v17 = *p_v15; // 0x1353c
        function_107b0(&i_v4, i_v17);
        int32_t *p_v18 = (int32_t *)(i_a2 + 16);            // 0x13558
        uint32_t i_v19 = function_10780((int32_t *)*p_v18); // 0x13560
    ...
    case 2: {
    lab_0x13634:;
        unsigned char i_v21 = *(char *)(*p_v1 + 1); // 0x1364c
        int32_t i_v22 = (int32_t)i_v21 - 102;       // 0x13650
        i_g6 = i_v22;
        char i_v23 = 0;    // 0x13658
        char i_v24 = 1;    // 0x13658
        int32_t i_v25 = 0; // 0x13658
        int32_t i_v26 = 0; // 0x13658
        char i_v27 = 0;    // 0x13658
        char i_v28 = 0;    // 0x13658
        int32_t i_v29;     // 0x1338c
        switch (i_v21) {
        case 120: {
            // 0x136c8
            i_v23 = 1;
        ...
        case 102: {
            int32_t i_v30 =
                function_128a0(&i_v4, &i_v2, &i_v6, &i_v8, i_v26,
                               (int32_t)i_v27, (int32_t)i_v28); // 0x13710
            i_v29 = i_v30;
            // break -> 0x13764
            break;
        }
    ...
    case 3: {
        int32_t *p_v31 = (int32_t *)(i_a2 + 8);             // 0x135b8
        uint32_t i_v32 = function_10780((int32_t *)*p_v31); // 0x135c0
        ...
        int32_t i_v33 = *p_v31; // 0x135ec
        function_107b0(&i_v4, i_v33);
        i_v10 = i_v33;
        i_v11 = i_v33;
        // branch (via goto) -> 0x13634
        goto lab_0x13634;
    }
    default: {
        // 0x13610
...
// Address range: 0x13770 - 0x137a4
int32_t function_13770(int32_t i_a1, int32_t i_a2, int32_t i_a3, int32_t i_a4) {
    int32_t i_v1 = function_106e8(i_a1, i_a2, i_a3, i_a4); // 0x13780
    return 0x24f0a - (int32_t)&i_g1 >> 2 == 0 ? i_v1 : i_a1;
}

// Address range: 0x137ac - 0x137ae
int32_t function_137ac(void) {
    // 0x137ac
    int32_t i_v1; // 0x137ac
    return i_v1;
}

// Address range: 0x137b0 - 0x137b4
int32_t function_137b0(int32_t i_a1, int32_t *p_a2) {
    // 0x137b0
    return i_a1;
}

// Address range: 0x137b4 - 0x137ba
int32_t function_137b4(void) {
    // 0x137b4
...
// Address range: 0xe3033b6c - 0xe3033b6d
int32_t function_e3033b6c(void) {
    // 0xe3033b6c
    int32_t i_v1; // 0xe3033b6c
    return i_v1;
}

// Address range: 0xe3033b7c - 0xe3033b7d
int32_t function_e3033b7c(void) {
    // 0xe3033b7c
    int32_t i_v1; // 0xe3033b7c
    return i_v1;
}
