  ...
  if (pcVar1 == (char *)0x0) {
    ...
    if (pcVar1 == (char *)0x0) {
      ...
      if (iVar2 == -1) {
        ...
        __assert_fail("sockfd_server != -1","update-daemon.c",0xa6,"ProcessServer");
      }
      ...
      do {
        ...
        iVar4 = pthread_create((pthread_t *)(local_44 + 2),(pthread_attr_t *)0x0,FUN_00010c94,local_44);
      } while (iVar4 != -1);
      fwrite("pthread_create error!\n",1,0x16,stderr);
      iVar2 = shutdown(iVar2,1);
      if (iVar2 == -1) {
                    /* WARNING: Subroutine does not return */
        __assert_fail("ret != -1","update-daemon.c",0xd0,"ProcessServer");
      }
...

{
  ...
  __libc_start_main(FUN_00010934,in_stack_00000000,&stack0x00000004,0x10fe1,&DAT_0001101d,param_1);
                    /* WARNING: Subroutine does not return */
  abort();
}
...
void FUN_00010fe0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
