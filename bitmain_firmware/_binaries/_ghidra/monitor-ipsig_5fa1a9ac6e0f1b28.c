...
{
  __libc_start_main(FUN_00009c40,param_2,&stack0x00000004,FUN_00009cd4,&DAT_00009d38,param_1);
...

{
  ...
  close(local_10);
  sprintf(local_c,"%02X:%02X:%02X:%02X:%02X:%02X",(uint)local_1e,(uint)local_1d,(uint)local_1c,(uint)local_1b,
          (uint)local_1a,(uint)local_19);
...

{
  ...
  iVar1 = DAT_00012294;
  sVar2 = strlen(acStack_78);
  local_14 = sendto(iVar1,acStack_78,sVar2,0,(sockaddr *)&DAT_000122d4,0x10);
  if (local_14 < 0) {
    printf("send error....");
  }
  else {
...

{
  ...
  sVar1 = sendto(DAT_00012294,param_1,10,0,(sockaddr *)&DAT_000122d4,0x10);
  if (sVar1 < 0) {
    printf("send error....");
    uVar2 = extraout_r3;
  }
...

{
  ...
  fStack_98.fds_bits[iVar1 >> 5] = fStack_98.fds_bits[iVar1 >> 5] | 1 << (DAT_00012294 % 0x20 & 0xffU);
  local_14 = (char *)0x0;
  local_14 = (char *)calloc(0x1e,1);
  iVar1 = select(DAT_00012294 + 1,&fStack_98,(fd_set *)0x0,(fd_set *)0x0,&local_a0);
  if (iVar1 != -1) {
    if (iVar1 == 0) {
      ...
      if ((fStack_98.fds_bits[iVar1 >> 5] >> (DAT_00012294 % 0x20 & 0xffU) & 1U) != 0) {
        local_a4 = 0x10;
        local_18 = recvfrom(DAT_00012294,local_14,0x1e,0,(sockaddr *)&DAT_000122c4,&local_a4);
        if (0 < local_18) {
          printf("rev:\n%s\t",local_14);
          DAT_000122c0 = 0;
...

{
  ...
  printf("monitor-ipsig compile %s--%s\n","Nov 12 2018","21:07:31",0,param_2,param_1);
  iVar1 = FUN_000094c8();
  do {
...
void FUN_00009cd4(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
