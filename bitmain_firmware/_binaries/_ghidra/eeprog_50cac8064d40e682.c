// Decompiled: eeprog_50cac8064d40e682
...
void FUN_00008828(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
...
LAB_00008890:
  do {
    while( true ) {
      while( true ) {
        ...
        if (uVar1 == 0xffffffff) {
          ...
          if (iVar10 == 0) {
            ...
            FUN_00008dbc(uVar1 >> 0x1f,
                         "unable to open eeprom device file (check that the file exists and that it\'s readable)",0x100)
            ;
            if (uVar2 == 0x72) {
              if (iVar9 == 0) {
                FUN_00008e40();
              ...
              FUN_00008e7c(auStack_90,local_98,local_94,local_a0);
            }
            else {
              if (uVar2 != 0x77) {
                    /* WARNING: Subroutine does not return */
      ...
      if (0x66 < (int)uVar1) break;
      if (uVar1 == 0x38) {
        FUN_00008dbc(iVar8,"EEPROM type switch (-8 or -16) used twice",0xc3);
        iVar8 = 1;
      }
      else if (uVar1 == 100) {
        iVar10 = iVar10 + 1;
        ...
        FUN_00008dbc(iVar8,"EEPROM type switch (-8 or -16) used twice",0xb9);
        iVar8 = 2;
      }
      else {
LAB_000088d4:
...
{
  __libc_start_main(FUN_00008858,param_2,&stack0x00000004,FUN_000094fc,&DAT_00009560,param_1);
                    /* WARNING: Subroutine does not return */
  abort();
}
...
void FUN_00008dbc(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
...
undefined4 FUN_00008e7c(undefined4 param_1,uint param_2,int param_3,int param_4)

{
  ...
  while (param_3 = param_3 + -1, param_3 != 0) {
    while( true ) {
      ...
      param_3 = param_3 + -1;
      uVar1 = uVar1 + 1;
      if (param_3 == 0) goto LAB_00008f28;
    }
    _IO_putc(__c,stdout);
  }
LAB_00008f28:
...
int FUN_000090ec(char *param_1,undefined4 param_2,undefined4 param_3,undefined4 *param_4)
...
void FUN_000094fc(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
