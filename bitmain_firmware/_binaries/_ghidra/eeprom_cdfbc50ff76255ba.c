// Decompiled: eeprom_cdfbc50ff76255ba
...
LAB_00008aec:
  ...
  do {
    ...
    if (uVar8 == 0) {
      iVar1 = 0;
      do {
        iVar2 = FUN_0000914c(__fd,iVar6 + local_130,iVar1,local_128 + iVar1,8);
        if (iVar2 < 0) goto LAB_00008aec;
        iVar1 = iVar1 + 8;
      } while (iVar1 != 0x100);
    }
    else {
      ...
      iVar1 = 0;
      do {
        iVar2 = FUN_00008ff0(__fd,iVar6 + local_130,iVar1,local_128 + iVar1,8);
        if (iVar2 < 0) goto LAB_00008aec;
        iVar1 = iVar1 + 8;
      } while (iVar1 != 0x100);
    }
    if ((uVar7 == 0 && -1 < local_140) && (sVar3 = write(local_140,local_128,0x100), sVar3 != 0x100)) {
...
{
  __libc_start_main(FUN_0000868c,param_2,&stack0x00000004,FUN_00009248,&DAT_000092ac,param_1);
                    /* WARNING: Subroutine does not return */
  abort();
}
...
undefined4 FUN_00008ff0(int param_1,undefined4 param_2,int param_3,int param_4,byte param_5)
...
undefined4 FUN_0000914c(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,byte param_5)
...
void FUN_00009248(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
