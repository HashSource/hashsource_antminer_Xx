// Decompiled: accelerometer_0fd2d97ccecd6c86
...

{
    ...
    if (iVar6 == 0) {
        ...
        while (iVar7 =
                   getopt_long(param_1, param_2, &DAT_0000b958, &DAT_0000b920),
               iVar7 != -1) {
            if (iVar7 != 100) {
                if (iVar7 == 0x68) {
        ...
        if (iVar7 == 0) {
            ...
            for (iVar6 = udev_enumerate_get_list_entry(uVar8); iVar6 != 0;
                 iVar6 = udev_list_entry_get_next(iVar6)) {
                uVar9 = udev_enumerate_get_udev(uVar8);
                uVar10 = udev_list_entry_get_name(iVar6);
                iVar11 = udev_device_new_from_syspath(uVar9, uVar10);
                if (iVar11 != 0) {
                    if (((__file == (char *)0x0) &&
                         (pcVar12 = (char *)udev_device_get_devnode(),
                          pcVar12 != (char *)0x0)) &&
                        (pcVar13 = strstr(pcVar12, "/event"),
                         pcVar13 != (char *)0x0)) {
            ...
            if (__file == (char *)0x0) {
                ...
                FUN_0000ae0c(
                    7,
                    "/home/fazio/Desktop/A8/setup-A8/build/"
                    "tmp-angstrom_v2013_06-eglibc/work/"
                    "armv7ahf-vfp-neon-angstrom-linux-gnueabi/systemd/1_208-r0/"
                    "systemd-208/src/udev/accelerometer/accelerometer.c",
                    0x151, &DAT_0000b918);
                pcVar12 = (char *)udev_device_get_property_value(
                    iVar7, "ID_INPUT_ACCELEROMETER_ORIENTATION");
                iVar6 = 0;
                if (pcVar12 != (char *)0x0) {
                    while (((&PTR_s_undefined_0000bb8c)[iVar6] != (char *)0x0 &&
                            (iVar7 = strcmp(pcVar12,
                                            (&PTR_s_undefined_0000bb8c)[iVar6]),
                             iVar7 != 0))) {
                        iVar6 = iVar6 + 1;
                    }
                }
                ...
                if (-1 < iVar6) {
                    ...
                    bVar2 = false;
                    local_1480 = 0;
                    while (sVar14 = read(iVar6, auStack_1474, 0x400),
                           0xf < sVar14) {
                        ...
                        do {
                            ...
                            } else if ((*(short *)(puVar16 + 8) == 0) &&
                                       (*(short *)(puVar16 + 10) == 0)) {
                                bVar2 = true;
                            }
                            if (((bool)(bVar5 & bVar4)) && (bVar3)) {
                                dVar17 = atan(
                                    (double)(longlong)local_1480 /
                                    SQRT((double)(longlong)(local_147c *
                                                                local_147c +
                                                            iVar7 * iVar7)));
                                uVar15 = lround(dVar17 * 57.29577951308232);
                                if ((int)((uVar15 ^ (int)uVar15 >> 0x1f) -
                                          ((int)uVar15 >> 0x1f)) < 0x15) {
                                    dVar17 = atan(
                                        (double)(longlong)local_147c /
                                        SQRT(
                                            (double)(longlong)(local_1480 *
                                                                   local_1480 +
                                                               iVar7 * iVar7)));
...
{
    __libc_start_main(FUN_00009158, param_2, &stack0x00000004, FUN_0000b8a8,
                      &DAT_0000b90c, param_1);
    /* WARNING: Subroutine does not return */
    abort();
}
...
int FUN_0000980c(int param_1, undefined4 param_2, undefined4 param_3,
                 undefined4 param_4)

{
    ...
    if (param_1 < 0) {
        ...
        FUN_0000ae34("fd >= 0",
                     "/home/fazio/Desktop/A8/setup-A8/build/"
                     "tmp-angstrom_v2013_06-eglibc/work/"
                     "armv7ahf-vfp-neon-angstrom-linux-gnueabi/systemd/"
                     "1_208-r0/systemd-208/src/shared/util.c",
...
void FUN_00009868(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
...
int FUN_000098bc(char *param_1, uint param_2, undefined4 param_3,
                 undefined4 param_4)
...

{
    ...
    if (param_1 == (uint *)0x0) {
        /* WARNING: Subroutine does not return */
        FUN_0000ae34(&DAT_0000cc54,
                     "/home/fazio/Desktop/A8/setup-A8/build/"
                     "tmp-angstrom_v2013_06-eglibc/work/"
                     "armv7ahf-vfp-neon-angstrom-linux-gnueabi/systemd/"
                     "1_208-r0/systemd-208/src/shared/time-util.c",
                     0x5e, "timespec_load");
    }
    uVar2 = *param_1;
    uVar1 = param_1[1];
    if ((uVar2 != 0xffffffff) || (uVar1 != 0xffffffff)) {
        ...
        uVar5 = FUN_0000afac(~(uint)lVar4, ~(uint)((ulonglong)lVar4 >> 0x20),
                             1000000, 0);
...

{
    ...
    FUN_0000ae34(
        ...
        "/home/fazio/Desktop/A8/setup-A8/build/tmp-angstrom_v2013_06-eglibc/"
        "work/armv7ahf-vfp-neon-angstrom-linux-gnueabi/systemd/1_208-r0/"
        "systemd-208/src/shared/time-util.c",
        0x1f, &DAT_0000cc50);
}

undefined4 *FUN_00009b34(undefined4 *param_1, undefined4 param_2, int param_3,
                         int param_4)
...
undefined4 FUN_00009d04(int param_1, uint param_2, int param_3, int param_4,
...

{
    ...
    __snprintf_chk(param_1, 0x800, 1, 0xffffffff,
                   "PRIORITY=%i\nSYSLOG_FACILITY=%i\n%s%.*s%s%s%.*i%s%s%.*s%s%"
                   "s%.*s%sSYSLOG_IDENTIFIER=%s\n",
                   param_2 & 7, (param_2 << 0x16) >> 0x19, pcVar3, uVar2,
                   param_3, local_3c, pcVar4, param_4 != 0, param_4, pcVar1,
                   pcVar5, local_2c, param_5, pcVar6, param_6, uVar8, param_7,
                   pcVar7, program_invocation_short_name);
    *(undefined1 *)(param_1 + 0x7ff) = 0;
    return 0;
}

void FUN_00009ef0(int param_1, undefined4 param_2, undefined4 param_3,
...

{
    ...
    if (DAT_00016010 >= 0) {
        FUN_00009d04(acStack_824, param_1, param_2, param_3, param_4, param_5,
                     param_6);
...
void FUN_0000a138(uint param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4, undefined4 param_5, undefined4 param_6,
                  char *param_7)

{
    ...
    if (DAT_00016038 == 8) {
        ...
        do {
            ...
            param_7 = (char *)0x0;
        LAB_0000a254:
            if ((DAT_00016038 == 6 || DAT_00016038 == 3) ||
                (DAT_00016038 == 2)) {
                iVar12 = FUN_00009ef0(param_1, param_2, param_3, param_4,
                                      param_5, param_6, __s);
                if (iVar12 < 0) {
                    if (iVar12 != -0xb) {
                        FUN_0000a10c();
            ...
            LAB_0000a274:
                ...
                LAB_0000a428:
                    ...
                    if (DAT_00016004 < 0)
                        goto LAB_0000a284;
                    __snprintf_chk(acStack_8c, 0x10, 1, 0x10, &DAT_0000d1c0,
                                   param_1);
                    local_7d = 0;
                    uVar18 = FUN_00009ae0(0);
                    local_d4 = FUN_0000afac((int)uVar18,
                ...
                LAB_0000a5b0:
                    ...
                    if (-1 < (int)uVar15) {
                        if ((DAT_00016034 == '\0') ||
                            (local_b4.iov_len + local_a8 + local_a0 + local_98 +
                                 local_94.iov_len <=
                             uVar15))
                            goto LAB_0000a794;
                        if (uVar15 != 0) {
                            ...
                            uVar15 = uVar15 - sVar5;
                            local_b4.iov_base =
                                (void *)((int)local_b4.iov_base + sVar5);
                            piVar11 = &local_b4;
                            do {
                                if (uVar15 == 0)
                                    break;
                                ...
                                piVar11 = piVar11 + 1;
                                piVar11->iov_base =
                                    (void *)((int)piVar1->iov_base + uVar10);
                ...
                LAB_0000a284:
                    ...
                    if (((!bVar17 ||
                          (DAT_00016038 == 3 || DAT_00016038 - 5 == 2)) ||
                         (DAT_00016038 == 1)) &&
                        (memset(&local_b4, 0, 0x28), -1 < DAT_00016008)) {
                        __snprintf_chk(acStack_7c, 0x10, 1, 0x10, &DAT_0000d1c0,
                                       param_1);
                        local_6d = 0;
                        _Var9 = getpid();
                        __snprintf_chk(acStack_6c, 0x10, 1, 0x10,
                                       "[%lu]: ", _Var9);
                        local_5d = 0;
                    ...
                    if (-1 < DAT_00016014) {
                        ...
                        if (uVar15 != 0) {
                            __snprintf_chk(acStack_6c, 0x40, 1, 0x40,
                                           "(%s:%u) ", param_2, param_3);
                            local_2d = 0;
                        ...
                        if ((bVar16 & 1) == 0) {
                            ...
                            (&local_b4)[uVar15].iov_base = &DAT_0000d1e8;
                            (&local_b4)[uVar15].iov_len = 7;
                            (&local_b4)[uVar15 + 1].iov_base = __s;
                            sVar5 = strlen(__s);
                            iVar13 = uVar15 + 3;
                            (&local_b4)[uVar15 + 1].iov_len = sVar5;
                            (&local_b4)[uVar15 + 2].iov_base = &DAT_0000c2d4;
                            (&local_b4)[uVar15 + 2].iov_len = 4;
                        }
                        (&local_b4)[iVar13].iov_base = &DAT_0000c1a0;
...
void FUN_0000a920(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4, undefined4 param_5)

{
    __snprintf_chk(&DAT_0001603c, 0x800, 1, 0x800, param_5, param_1, param_2,
                   param_3, param_4);
...

{
    ...
    if (((DAT_00016038 - 6 < 2) && (_Var2 = getpid(), _Var2 != 1)) &&
        (iVar1 = isatty(2), 0 < iVar1)) {
    LAB_0000aa2c:
        FUN_0000a10c();
        FUN_0000a0e0();
        FUN_0000a064();
        ...
        LAB_0000aa0c:
            ...
            if ((((bVar7 && (uVar6 != 3 && uVar6 != 7)) && (uVar6 != 5)) &&
                 (uVar6 != 1)) ||
                (iVar1 = FUN_00009bd4(), iVar1 < 0))
                goto LAB_0000aa2c;
            FUN_0000a10c();
        }
        FUN_0000a0e0();
...
void FUN_0000ad24(uint param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4, undefined4 param_5, undefined4 param_6)

{
    ...
    if (DAT_00016000 < (int)(param_1 & 7)) {
        ...
        local_2d = 0;
        uVar2 =
            FUN_0000a138(param_1, param_2, param_3, param_4, 0, 0, auStack_82c);
    }
    *piVar1 = iVar3;
    if (local_2c != __stack_chk_guard) {
        /* WARNING: Subroutine does not return */
...
void FUN_0000ae50(uint param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
...
void FUN_0000afac(undefined4 param_1, undefined4 param_2, int param_3,
                  int param_4)
...
void FUN_0000aff8(uint param_1, int param_2, undefined4 param_3,
...
void FUN_0000b034(uint param_1, int param_2, undefined4 param_3,
                  undefined4 param_4, int *param_5)
    ...
    if (param_4 == 0) {
        if (uVar5 <= uVar11) {
            ...
            if (iVar4 == 0) {
                ...
                FUN_0000af48(uVar12 - uVar11, uVar7, uVar11, uVar12, param_1,
                             param_2, param_3);
            ...
            FUN_0000af48(uVar9 - uVar12, uVar11, uVar12, uVar9, param_1,
                         param_2, param_3);
        ...
        FUN_0000af48(uVar5 - uVar11, uVar12, uVar11, uVar5, param_1, param_2,
                     param_3);
    ...
    LAB_0000b498:
        ...
        if (param_4 <= uVar11) {
            ...
            if (iVar4 != 0) {
                ...
                uVar11 = uVar9 >> 0x10;
                FUN_0000af48(uVar7, uVar11, uVar7, param_4, param_1, uVar7,
                             param_3);
    ...
    if (param_4 == 0) {
        if (param_3 <= param_2) {
            ...
            if (iVar6 == 0) {
                ...
                FUN_0000af48(uVar8 - uVar5, uVar9, uVar5, uVar8, uVar3, uVar12,
                             uVar10);
            ...
            FUN_0000af48(uVar11 - uVar8, uVar5, uVar8, uVar11, uVar3, uVar12,
                         uVar10);
        ...
        FUN_0000af48(uVar7 - uVar12, uVar10, uVar12, uVar7, param_1, param_2,
                     param_3);
    ...
    LAB_0000b88c:
        ...
        if (param_4 <= param_2) {
            ...
            if (iVar6 != 0) {
                ...
                uVar3 = uVar12 >> 0x10;
                FUN_0000af48(uVar9, uVar3, param_3, param_4, param_1, param_2,
                             param_3);
                iVar2 = extraout_r1_05;
...
void FUN_0000b8a8(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
