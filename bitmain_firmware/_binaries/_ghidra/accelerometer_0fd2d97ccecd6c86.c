...
LAB_000091d8:
    ...
    if (iVar7 == 0) {
      ...
      if (__file == (char *)0x0) {
        ...
        FUN_0000ae0c(7,
                     "/home/fazio/Desktop/A8/setup-A8/build/tmp-angstrom_v2013_06-eglibc/work/armv7ahf-vfp-neon-angstrom-linux-gnueabi/systemd/1_208-r0/systemd-208/src/udev/accelerometer/accelerometer.c"
                     ,0x151,&DAT_0000b918);
        ...
        if (pcVar12 != (char *)0x0) {
          while (((&PTR_s_undefined_0000bb8c)[iVar6] != (char *)0x0 &&
                 (iVar7 = strcmp(pcVar12,(&PTR_s_undefined_0000bb8c)[iVar6]), iVar7 != 0))) {
            iVar6 = iVar6 + 1;
          }
        }
...

{
  ...
  if (param_1 < 0) {
                    /* WARNING: Subroutine does not return */
    FUN_0000ae34("fd >= 0",
                 "/home/fazio/Desktop/A8/setup-A8/build/tmp-angstrom_v2013_06-eglibc/work/armv7ahf-vfp-neon-angstrom-linux-gnueabi/systemd/1_208-r0/systemd-208/src/shared/util.c"
...

{
  ...
  if (param_1 == (uint *)0x0) {
    ...
    FUN_0000ae34(&DAT_0000cc54,
                 "/home/fazio/Desktop/A8/setup-A8/build/tmp-angstrom_v2013_06-eglibc/work/armv7ahf-vfp-neon-angstrom-linux-gnueabi/systemd/1_208-r0/systemd-208/src/shared/time-util.c"
                 ,0x5e,"timespec_load");
  }
  uVar2 = *param_1;
  uVar1 = param_1[1];
...
LAB_0000a428:
          ...
          __snprintf_chk(acStack_8c,0x10,1,0x10,&DAT_0000d1c0,param_1);
          local_7d = 0;
...
LAB_0000a284:
          ...
          if (((!bVar17 || (DAT_00016038 == 3 || DAT_00016038 - 5 == 2)) || (DAT_00016038 == 1)) &&
            ...
            __snprintf_chk(acStack_7c,0x10,1,0x10,&DAT_0000d1c0,param_1);
            local_6d = 0;
            _Var9 = getpid();
...

{
  ...
  FUN_0000ae34("(level & 0x07) == level",
               "/home/fazio/Desktop/A8/setup-A8/build/tmp-angstrom_v2013_06-eglibc/work/armv7ahf-vfp-neon-angstrom-linux-gnueabi/systemd/1_208-r0/systemd-208/src/shared/log.c"
