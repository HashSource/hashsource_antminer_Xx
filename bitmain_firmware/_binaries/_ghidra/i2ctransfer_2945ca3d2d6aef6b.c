...

{
  ...
  for (iVar5 = 0; iVar5 != param_2; iVar5 = iVar5 + 1) {
    ...
    if (uVar6 != 0) {
      ...
      fprintf(__stream,"msg %u: addr 0x%02x, %s, len %u",iVar5,(uint)*param_1,pcVar1,(uint)param_1[2]);
    }
    if (param_1[2] == 0) {
      uVar4 = 0;
    }
    if (uVar4 == 0) {
      ...
      while( true ) {
        ...
        if ((int)(param_1[2] - 1) <= (int)uVar6) break;
...
LAB_00010f70:
  ...
  if ((-1 < iVar4) && (iVar4 = FUN_000116a8(iVar4,auStack_234,0x14,0), -1 < iVar4)) {
...
LAB_00010e14:
        local_254 = local_254 + 1;
        if (param_1 <= local_254) goto LAB_000111c4;
        puVar9 = local_250 + 1;
          ...
          while (uVar17 = uVar18, uVar18 < uVar2) {
            ...
            *(char *)(local_218[iVar5 * 3] + uVar18) = (char)uVar13;
            ...
            if (bVar1 == 0x2d) {
              ...
              if (bVar1 != 0x2b) goto LAB_00011104;
              uVar13 = uVar13 + 1 & 0xff;
            }
            else if (bVar1 != 0x3d) {
              if (bVar1 != 0x70) {
LAB_00011104:
              ...
              uVar13 = (uVar17 & 0xff) >> 7 | (uVar17 & 0x7f) << 1;
            }
          }
          local_250 = puVar9;
          if (uVar17 != uVar2) goto LAB_00010e14;
        }
        else {
          if (*pbVar12 == 0x72) {
            sVar21 = 1;
          ...
          uVar6 = strtoul((char *)(pbVar12 + 1),(char **)&local_23c,0);
...
LAB_000110dc:
          ...
          if (*local_23c != 0) {
            if (*local_23c == 0x40) {
              ...
              if ((-1 < local_258) && ((iVar15 != 0 || (iVar20 = FUN_00011f14(iVar4,local_258,0), iVar20 == 0))))
              goto LAB_00010eb8;
            }
            else {
...

{
  ...
  __libc_start_main(FUN_00010c64,in_stack_00000000,&stack0x00000004,0x12029,&DAT_00012065,param_1);
                    /* WARNING: Subroutine does not return */
  abort();
}
...
uint FUN_000116a8(undefined4 param_1,char *param_2,size_t param_3,int param_4)
            ...
            while( true ) {
              ...
              if (pFVar2 == (FILE *)0x0) {
                ...
                if (pFVar2 == (FILE *)0x0) {
                  ...
                  if (__dirp_00 == (DIR *)0x0) goto LAB_00011a5c;
                  do {
                    while( true ) {
                      do {
                        pdVar11 = readdir64(__dirp_00);
                        if (pdVar11 == (dirent64 *)0x0) goto LAB_00011a5c;
              ...
              if (iVar9 == 0) goto LAB_00011a5c;
              iVar9 = strncmp(acStack_3a0,"ISA ",4);
              if (iVar9 == 0) {
                iVar9 = 1;
              }
              else {
                iVar3 = FUN_000116a8(local_3bc,auStack_3b4,0x14,1);
                if (iVar3 < 0) {
                  iVar9 = 4;
                }
                else {
              ...
              uVar12 = uVar14 + 1;
              if (((uVar12 & 7) == 0) && (pvVar1 = (void *)FUN_000115a8(pvVar1,uVar12), pvVar1 == (void *)0x0)) {
                return (void *)0x0;
              }
              *(undefined4 *)((int)pvVar1 + uVar14 * 0x10) = local_3bc;
              iVar3 = __strdup(acStack_3a0);
              *(int *)((int)pvVar1 + uVar14 * 0x10 + 4) = iVar3;
              if (iVar3 == 0) goto LAB_00011950;
              puVar13 = (&PTR_s_Dummy_bus_000126a0)[iVar9 * 2];
              *(undefined **)((int)pvVar1 + uVar14 * 0x10 + 8) = (&PTR_s_dummy_0001269c)[iVar9 * 2];
              *(undefined **)((int)pvVar1 + uVar14 * 0x10 + 0xc) = puVar13;
              pdVar11 = readdir64(__dirp);
              uVar14 = uVar12;
              if (pdVar11 == (dirent64 *)0x0) goto LAB_00011bac;
            }
            fprintf(stderr,"%s: path truncated\n",local_128);
            goto LAB_00011a5c;
          }
LAB_00011bac:
      ...
      while( true ) {
        ...
        *pcVar6 = '\0';
        ...
        if (((uVar14 & 7) == 0) && (pvVar1 = (void *)FUN_000115a8(pvVar1,uVar14), pvVar1 == (void *)0x0)) {
          return (void *)0x0;
        }
...

{
  ...
  if (__s1 != (char *)0x0) {
    ...
    if (uVar2 != 0xffffffff) goto LAB_00011e60;
  }
  uVar2 = 0xffffffff;
...
LAB_00012020:
    ...
    if (local_14[0] < 0x5a) {
      if (local_14[0] != 0x4e) goto LAB_00011fd4;
    }
    else if (local_14[0] != 0x6e) {
      if (local_14[0] != 0x79) goto LAB_00011fd4;
      goto LAB_00012020;
    }
    param_1 = 0;
  }
...
void FUN_00012028(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
