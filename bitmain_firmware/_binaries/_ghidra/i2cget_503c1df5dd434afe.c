    ...
    do {
        ...
        LAB_00010cf8:
            if (bVar16)
                goto LAB_00010e04;
            if (((param_1 <= iVar6 + 2) ||
                 (iVar4 = FUN_00011d6c(param_2[iVar10]), iVar4 < 0)) ||
...
void FUN_00011fd4(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
