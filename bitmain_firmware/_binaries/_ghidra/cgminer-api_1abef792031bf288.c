...
LAB_00010b30:
  ...
  if (*pcVar7 == '-') {
    cVar1 = pcVar7[1];
    if (cVar1 == '?') {
      if (pcVar7[2] == '\0') goto LAB_00010b68;
    }
    else if (cVar1 == 'h') {
      if (pcVar7[2] == '\0') goto LAB_00010b68;
      goto LAB_00010a40;
    ...
    if (iVar2 == 0) goto LAB_00010b68;
    if ((cVar1 != 'o') || (pcVar7[2] != '\0')) goto LAB_00010a58;
    if (param_1 != 2) {
      pcVar7 = (char *)0x2;
    }
    DAT_00022080 = 1;
    if (param_1 == 2) goto LAB_00010b30;
  }
  else {
LAB_00010a40:
    iVar2 = strcmp(pcVar7,"--help");
...
LAB_00010a58:
  ...
  if ((int)(pcVar7 + 1) < param_1) {
    ...
    if (((int)(pcVar7 + 2) < param_1) && (pcVar7 = (char *)FUN_00010c70(param_2[(int)(pcVar7 + 2)]), *pcVar7 != '\0')) {
...

{
  ...
  __libc_start_main(main,in_stack_00000000,&stack0x00000004,0x11209,0x11245,param_1);
...
LAB_00010e38:
              ...
              *pcVar2 = '\0';
              if (iVar6 == 0) {
                if (pcVar7 == (char *)0x0) goto LAB_00010e58;
              ...
              else if (pcVar7 == (char *)0x0) goto LAB_00010e38;
              printf("   [%s] => %s\n",param_1,pcVar7);
            }
          }
          else {
            *pcVar4 = '\0';
            pcVar4 = pcVar4 + 1;
            if (*param_1 != '\0') goto LAB_00010d7c;
          }
          param_1 = pcVar4;
          iVar6 = iVar6 + 1;
        ...
        *pcVar1 = '\0';
        pcVar1 = pcVar1 + 1;
        if (*param_1 != '\0') goto LAB_00010d58;
      }
      param_1 = pcVar1;
    } while (param_1 != (char *)0x0);
  }
...

{
  ...
  local_38.sa_data._0_2_ = (ushort)((param_3 & 0xff) << 8) | (ushort)(param_3 >> 8) & 0xff;
