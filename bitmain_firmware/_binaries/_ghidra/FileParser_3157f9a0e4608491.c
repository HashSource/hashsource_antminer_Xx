...

{
    ...
    __libc_start_main(FUN_000133d0, in_stack_00000000, &stack0x00000004,
                      0x137b5, &DAT_000137f1, param_1);
...
undefined4 FUN_00010c50(void *param_1, size_t param_2, uchar *param_3,
                        void *param_4)
...
undefined4 FUN_00010dc8(FILE *param_1, int param_2, undefined4 *param_3,
...

{
    ...
    uVar1 = VectorShiftLeft(
        CONCAT44(param_2, param_1),
        in_d17 & 0xffffffffffff0000 | (ulonglong)(-param_3 & 0x3f), 8, 1);
    return CONCAT44((uint)((ulonglong)uVar1 >> 0x20) |
                        param_2 >> (param_3 & 0xff),
                    (uint)uVar1 | param_1 >> (param_3 & 0xff) |
                        param_2 << (0x20 - param_3 & 0xff) |
                        param_2 >> (param_3 - 0x20 & 0xff));
}

undefined8 FUN_00011550(uint param_1, uint param_2, uint param_3, uint param_4,
...

{
    ...
    if (param_2 < 8) {
        if (param_2 < 4) {
            ...
            lVar6 =
                FUN_00011550(uVar2 * 8 + param_2,
                             (uVar2 >> 0x1d) + (uint)CARRY4(uVar2 * 8, param_2),
        ...
        lVar6 = FUN_00011550((int)lVar8, (int)((ulonglong)lVar8 >> 0x20),
                             (int)lVar1, (int)((ulonglong)lVar1 >> 0x20), iVar4,
                             iVar5);
    }
    return lVar6;
}
...

{
    ...
    uVar1 =
        FUN_00011550((int)lVar8, (int)((ulonglong)lVar8 >> 0x20), (int)lVar6,
...

{
    ...
    lVar9 = FUN_000114e4((int)(lVar5 + lVar6),
    ...
    lVar6 =
        FUN_00011550((int)lVar8, (int)((ulonglong)lVar8 >> 0x20), (int)lVar7,
    ...
    lVar5 = FUN_000114e4((int)(lVar10 + lVar5),
                         (int)((ulonglong)(lVar10 + lVar5) >> 0x20), 0x12);
    lVar8 = lVar8 + lVar5 + lVar9 * lVar1;
    uVar2 =
        FUN_00011550((int)lVar7, (int)((ulonglong)lVar7 >> 0x20), (int)lVar8,
                     (int)((ulonglong)lVar8 >> 0x20), iVar3, iVar4);
    return uVar2;
}

int *FUN_00011ed0(int *param_1, undefined4 param_2, uint param_3, int param_4,
                  uint param_5, int param_6, uint param_7, int param_8,
                  uint param_9, int param_10, undefined8 param_11,
                  undefined8 param_12)

{
    ...
    lVar5 = FUN_000114e4((uint)param_12 + uVar1 + param_9,
                         param_12._4_4_ + iVar3 +
                             (uint)CARRY4((uint)param_12, uVar1) + param_10 +
                             (uint)CARRY4((uint)param_12 + uVar1, param_9),
                         0x15);
    uVar2 = param_7 + param_5 + uVar1;
    iVar4 = param_8 + param_6 + iVar3 + (uint)CARRY4(param_5, uVar1) +
            (uint)CARRY4(param_7, param_5 + uVar1);
...
undefined4 FUN_00011fd4(undefined4 param_1, int param_2, undefined4 param_3,
...

{
    ...
    FUN_00011ed0(param_1, (int)((ulonglong)uVar4 >> 0x20), (int)uVar1,
...

{
    ...
    if (param_2 < 0x11) {
        ...
        do {
            ...
            local_38 = lVar12;
            lVar11 = lVar11 + lVar2;
            lVar12 = FUN_000114e4((int)lVar11, (int)((ulonglong)lVar11 >> 0x20),
                                  0x25);
            local_28 = lVar12 * -0x4b6d499041670d8d;
            lVar11 = local_30 + local_58;
            lVar12 = FUN_00011460(local_74 + 0x30);
            lVar12 = lVar12 + lVar11;
            lVar11 = FUN_000114e4((int)lVar12, (int)((ulonglong)lVar12 >> 0x20),
                                  0x2a);
            lVar12 = local_60;
        ...
        iVar3 = local_70._4_4_ + local_60._4_4_ +
                (uint)CARRY4(uVar6, (uint)local_60);
        ...
        lVar12 = lVar12 + lVar11;
        lVar12 =
            FUN_000114e4((int)lVar12, (int)((ulonglong)lVar12 >> 0x20), 0x25);
        local_28 = lVar12 * CONCAT44(local_4c, local_50);
        lVar11 = local_30 + local_58;
        lVar12 = FUN_00011460(local_74 + 0x30);
        lVar12 = lVar12 + lVar11;
        lVar12 =
            FUN_000114e4((int)lVar12, (int)((ulonglong)lVar12 >> 0x20), 0x2a);
        ...
        local_28._4_4_ = (int)((ulonglong)uVar10 >> 0x20) + local_68._4_4_ +
                             (uint)CARRY4((uint)uVar10, (uint)local_68) ^
                         local_28._4_4_;
        ...
        local_38 =
            FUN_000114e4((uint)local_70 + (uint)local_38,
                         local_70._4_4_ + local_38._4_4_ +
                             (uint)CARRY4((uint)local_70, (uint)local_38),
                         0x21);
        ...
        FUN_00011fd4(&local_88, local_74, (int)lVar12,
                     local_58._4_4_ * local_50 + (int)local_58 * local_4c +
                         (int)((ulonglong)lVar12 >> 0x20),
                     (uint)local_28 + (uint)local_70,
                     local_28._4_4_ + local_70._4_4_ +
                         (uint)CARRY4((uint)local_28, (uint)local_70));
        ...
        lVar12 = local_38 + local_68;
        lVar11 = FUN_00011460(local_74 + 0x10);
        FUN_00011fd4(&local_88, iVar3, (int)lVar12,
                     (int)((ulonglong)lVar12 >> 0x20), lVar11 + local_30);
        ...
        local_38._0_4_ = uVar5;
        local_38._4_4_ = uVar7;
        lVar12 = FUN_00011550((uint)local_60, local_60._4_4_, local_88,
                              uStack_84, local_50, local_4c);
        ...
        lVar11 = FUN_00011550((int)local_58, local_58._4_4_, (uint)local_68,
                              local_68._4_4_, local_50);
        uVar10 = FUN_00011550((int)lVar12, (int)((ulonglong)lVar12 >> 0x20),
                              (int)(lVar11 + local_28),
                              (int)((ulonglong)(lVar11 + local_28) >> 0x20),
                              local_50, local_4c);
    }
    return uVar10;
}

int FUN_000128a0(char *param_1, char *param_2, char *param_3, char *param_4,
                        ...
                        if (local_14 == local_24) {
                            ...
                            if (local_3c == (FILE *)0x0) {
                                ...
                                local_40 = (uint)CONCAT11(param_4[0x16],
                                                          param_4[0x17]);
                                local_44 =
                                    FUN_00010c50(param_4 + 0x18, local_40,
...

{
    ...
    if (param_1 < 2) {
        ...
        case 0x66:
            local_10 = FUN_000128a0(local_190, local_110, local_210,
...
void FUN_000137b4(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
