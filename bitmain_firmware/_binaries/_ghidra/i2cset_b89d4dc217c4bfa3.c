// Decompiled: i2cset_b89d4dc217c4bfa3
...

{
  ...
  __libc_start_main(&LAB_00010d44,in_stack_00000000,&stack0x00000004,0x12701,&DAT_0001273d,param_1);
...
/* WARNING: Removing unreachable block (ram,0x00011b30) */

void FUN_00011b1c(void)
...
/* WARNING: Removing unreachable block (ram,0x00011b54) */
/* WARNING: Removing unreachable block (ram,0x00011b5e) */
...
/* WARNING: Removing unreachable block (ram,0x00011b80) */
/* WARNING: Removing unreachable block (ram,0x00011b8a) */

void FUN_00011b64(void)
...
void FUN_00011bac(void)

{
  fwrite("Usage: i2cset [-f] [-y] [-m MASK] [-r] [-a] I2CBUS CHIP-ADDRESS DATA-ADDRESS [VALUE] ... [MODE]\n  I2CBUS is an integer or an I2C bus name\n  ADDRESS is an integer (0x03 - 0x77, or 0x00 - 0x7f if -a is given)\n  MODE is one of:\n    c (byte, no value)\n    b (byte data, default)\n    w (word data)\n    i (I2C block data)\n    s (SMBus block data)\n    Append p for SMBus PEC\n"
         ,1,0x170,stderr);
                    /* WARNING: Subroutine does not return */
  exit(1);
}
...
void FUN_00011c48(void *param_1)
...
void * FUN_00011c80(void *param_1,int param_2)
...
long FUN_00011cc8(char *param_1,int param_2)
...
uint FUN_00011d80(undefined4 param_1,char *param_2,size_t param_3,int param_4)
            ...
            while( true ) {
              ...
              if (pFVar2 == (FILE *)0x0) {
                ...
                if (pFVar2 == (FILE *)0x0) {
                  ...
                  if (__dirp_00 == (DIR *)0x0) goto LAB_00012134;
                  do {
                    while( true ) {
                      do {
                        pdVar11 = readdir64(__dirp_00);
                        if (pdVar11 == (dirent64 *)0x0) goto LAB_00012134;
              ...
              if (iVar9 == 0) goto LAB_00012134;
              iVar9 = strncmp(acStack_3a0,"ISA ",4);
              if (iVar9 == 0) {
                iVar9 = 1;
              }
              else {
                iVar3 = FUN_00011d80(local_3bc,auStack_3b4,0x14,1);
                if (iVar3 < 0) {
                  iVar9 = 4;
                }
                else {
              ...
              uVar12 = uVar14 + 1;
              if (((uVar12 & 7) == 0) && (pvVar1 = (void *)FUN_00011c80(pvVar1,uVar12), pvVar1 == (void *)0x0)) {
                return (void *)0x0;
              }
              *(undefined4 *)((int)pvVar1 + uVar14 * 0x10) = local_3bc;
              iVar3 = __strdup(acStack_3a0);
              *(int *)((int)pvVar1 + uVar14 * 0x10 + 4) = iVar3;
              if (iVar3 == 0) goto LAB_00012028;
              puVar13 = (&PTR_s_Dummy_bus_00012e58)[iVar9 * 2];
              *(undefined **)((int)pvVar1 + uVar14 * 0x10 + 8) = (&PTR_s_dummy_00012e54)[iVar9 * 2];
              *(undefined **)((int)pvVar1 + uVar14 * 0x10 + 0xc) = puVar13;
              pdVar11 = readdir64(__dirp);
              uVar14 = uVar12;
              if (pdVar11 == (dirent64 *)0x0) goto LAB_00012284;
            }
            fprintf(stderr,"%s: path truncated\n",local_128);
            goto LAB_00012134;
          }
LAB_00012284:
      ...
      while( true ) {
        ...
        *pcVar8 = '\0';
        iVar3 = FUN_00011bd8(pcVar8 + 1);
        pcVar4 = strrchr(acStack_3a0,9);
        *pcVar4 = '\0';
        iVar5 = FUN_00011bd8(pcVar4 + 1);
        pcVar6 = strrchr(acStack_3a0,9);
        *pcVar6 = '\0';
        iVar7 = FUN_00011bd8(pcVar6 + 1);
        __isoc99_sscanf(acStack_3a0,"i2c-%d",local_128);
        if (((uVar14 & 7) == 0) && (pvVar1 = (void *)FUN_00011c80(pvVar1,uVar14), pvVar1 == (void *)0x0)) {
          return (void *)0x0;
        }
...
ulong FUN_00012498(char *param_1)

{
  ...
  if (__s1 != (char *)0x0) {
    ...
    if (uVar2 != 0xffffffff) goto LAB_00012538;
  }
  uVar2 = 0xffffffff;
...
int FUN_000125ec(int param_1,undefined4 param_2,int param_3)
...
undefined4 FUN_00012660(undefined4 param_1)
...
LAB_000126f8:
    ...
    if (local_14[0] < 0x5a) {
      if (local_14[0] != 0x4e) goto LAB_000126ac;
    }
    else if (local_14[0] != 0x6e) {
      if (local_14[0] != 0x79) goto LAB_000126ac;
      goto LAB_000126f8;
    }
    param_1 = 0;
  }
...
void FUN_00012700(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
