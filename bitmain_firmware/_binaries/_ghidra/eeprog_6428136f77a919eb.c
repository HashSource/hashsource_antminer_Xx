    ...
    if (iVar1 == 0x66) {
      ...
      if (iVar1 == 0x38) {
        if (iVar6 != 0) {
          ...
          FUN_00010e48("EEPROM type switch (-8 or -16) used twice",0xc1);
        }
        iVar6 = 1;
      }
      else if (iVar1 == 100) {
        ...
        if (iVar6 != 0) {
                    /* WARNING: Subroutine does not return */
          FUN_00010e48("EEPROM type switch (-8 or -16) used twice",0xb7);
        }
        iVar6 = 2;
      }
      else {
...
LAB_00010d10:
      ...
      if (iVar1 != 0x78) {
        if (iVar1 != 0x68) goto LAB_000109a4;
        FUN_00010e18(0xcb);
        break;
      }
      local_b0 = local_b0 + 1;
...
LAB_00010d50:
    ...
    __libc_start_main(FUN_00010920,in_stack_ffffff40,auStack_bc,0x11535,&DAT_00011571,uVar4,auStack_bc);
                    /* WARNING: Subroutine does not return */
    abort();
  }
  uVar3 = strtoul(__nptr,(char **)0x0,0);
  if (((DAT_000230a8 == 0) && (fprintf(stderr,"eeprog %s, a 24Cxx EEPROM reader/writer\n","0.7.5"), DAT_000230a8 == 0))
     && (fwrite("Copyright (c) 2003 by Stefano Barbato - All rights reserved.\n",1,0x3d,stderr), DAT_000230a8 == 0)) {
    if (iVar6 == 1) {
      in_stack_ffffff40 = 8;
    }
    else {
...
LAB_00010d38:
                    /* WARNING: Subroutine does not return */
      FUN_00010e48("unable to open eeprom device file (check that the file exists and that it\'s readable)",0xfe);
    }
    if (iVar7 == 0x72) {
      if (local_b4 == 0) {
        FUN_00010ef8();
...

{
  ...
  __libc_start_main(FUN_00010920,in_stack_00000000,&stack0x00000004,0x11535,&DAT_00011571,param_1);
                    /* WARNING: Subroutine does not return */
  abort();
}
...
undefined4 FUN_00010f34(undefined4 param_1,uint param_2,int param_3,int param_4)

{
  ...
  while (param_3 = param_3 + -1, param_3 != 0) {
    while( true ) {
      ...
      param_3 = param_3 + -1;
      uVar2 = uVar2 + 1;
      if (param_3 == 0) goto LAB_00010fe0;
    }
    _IO_putc(iVar1,stdout);
  }
LAB_00010fe0:
...
int FUN_0001118c(char *param_1,undefined4 param_2,undefined4 param_3,undefined4 *param_4)
...

{
  ...
  if (*(int *)(param_1 + 0xc) == 1) {
    iVar1 = i2c_smbus_write_byte(*(undefined4 *)(param_1 + 8),param_2 & 0xff);
    __stream = stderr;
    if (iVar1 < 0) {
      piVar2 = __errno_location();
      pcVar3 = strerror(*piVar2);
...

{
  ...
  if (*(int *)(param_1 + 0xc) != 1) {
    if (*(int *)(param_1 + 0xc) == 2) {
      iVar1 = i2c_smbus_write_word_data(*(undefined4 *)(param_1 + 8),param_2 >> 8,param_2 & 0xff | param_3 << 8);
      __stream = stderr;
      if (iVar1 < 0) {
        piVar2 = __errno_location();
        pcVar3 = strerror(*piVar2);
...
void FUN_00011534(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
