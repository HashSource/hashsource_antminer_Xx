...
LAB_00008608:
      ...
      if (iVar1 != 1) {
        while (gettimeofday(&local_18,(__timezone_ptr_t)0x0),
              3000000 < ((local_18.tv_sec - local_20.tv_sec) * 1000000 + local_18.tv_usec) - local_20.tv_usec) {
...
{
  __libc_start_main(FUN_000085c4,param_2,&stack0x00000004,FUN_00008974,&DAT_000089d8,param_1);
                    /* WARNING: Subroutine does not return */
  abort();
}
...
void FUN_00008974(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
