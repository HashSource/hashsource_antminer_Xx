...

{
  ...
  __libc_start_main(FUN_00010438,in_stack_00000000,&stack0x00000004,0x1090d,&DAT_00010949,param_1);
...

{
  ...
  if (sVar2 == 0) {
    ...
    do {
      pbVar4 = pbVar5 + 1;
      uVar11 = *(uint *)(&DAT_00021040 + ((uint)*pbVar5 ^ uVar11 >> 8) * 4) & 0xffff ^ (uVar11 & 0xff) << 8;
      pbVar5 = pbVar4;
    ...
    do {
      pbVar4 = pbVar5 + 1;
      uVar6 = *(uint *)(&DAT_00010958 + ((uint)*pbVar5 ^ uVar6 >> 0x18) * 4) ^ uVar6 << 8;
      pbVar5 = pbVar4;
    } while (pbVar4 != param_1 + sVar2);
    uVar9 = uVar11 & 0xfe;
  ...
  sprintf(param_2,"%02x:%02x:%02x:%02x:%02x:%02x",uVar9,uVar11,uVar12,uVar3,uVar6,uVar7);
  return;
}
...

{
  ...
  if (DAT_00021448 == 0) {
    ...
    } while ((DAT_00021450 == 0 && DAT_00021454 == 0) && (DAT_00021458 == 0 && DAT_0002145c == 0));
    DAT_00021448 = 1;
  }
  else {
    local_40 = DAT_00021458;
  ...
  DAT_00021450 = local_40 ^ (local_40 >> 5 | uStack_3c << 0x1b) ^ uVar2 ^ (uVar2 >> 0x12 | uVar3 << 0xe);
  DAT_00021454 = uStack_3c ^ uStack_3c >> 5 ^ uVar3 ^ uVar3 >> 0x12;
  DAT_00021458 = DAT_00021450 ^ (uVar4 >> 0x12 | uVar5 << 0xe) ^ uVar4 ^ (DAT_00021450 >> 5 | DAT_00021454 << 0x1b);
  ...
  iStack_2c = DAT_00021454 + DAT_0002145c + (uint)CARRY4(DAT_00021450,DAT_00021458);
  uVar2 = 0x78;
  do {
    while( true ) {
      pcVar6 = param_1;
...
void FUN_0001090c(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
